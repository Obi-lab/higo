  ...
  return (
    <div className='w-[94%] mx-auto pb-5  mt-3  items-center' id="testimonials">
      <div>
        ...
        <p className='text-2xl py-2'>What some of our clients are saying about us</p>
      ...
      <div className='pt-2 flex flex-col gap-4 md:flex-row '>
        ...
        in both construction technology and Quantity Surveying saved us time and money. They turned our 
        complex project into a seamless, cost-effective success.</p>
        ...
        <div className=' border-t border-r rounded-2xl p-2  border-gray-200'>
            ...
            They truly understand how to leverage technology for top-notch results.</p>
        ...
        <div className=' border-t border-r rounded-2xl p-2  border-gray-200'>
          ...
          Their professionalism and expertise are second to none</p>
