...
function About() {
  return (
    <div className='mt-2 w-[94%] bg-[#1f3528] mx-auto pt-5 pb-5 mt-3 text-gray-300 rounded-3xl' id="about">
        <div className='px-2'>
            <div className='flex md:flex-row flex-col gap-4'>
                ...
                <div className='md:w-[50%]'>
                    ...
                    <Link to='/portfolio'>
                        <button className='border border-gray-300 rounded-full px-6  my-2'>More</button>
                    </Link>
                </div>
            ...
            <div className='md:w-[30%] border-b border-gray-300 flex flex-col gap-2'>
                ...
                <div className=' px-2 flex flex-col items-center'>
                    ...
                    <div className=' md:w-[97%] flex gap-6 py-1 mx-auto'>
                        ...
                        <div class=" flex flex-row gap-5 items-center mx-auto">
                            <img className='py-1 w-10 ' src={Email} />
