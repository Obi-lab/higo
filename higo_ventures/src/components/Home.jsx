...
function Home() {
  return (
    <div className='mt-2 w-[94%] mx-auto pt-5 mt-3 ; ' id="home">
                    ...
                    <div className='md:w-[50%]'>
                        ...
                        <div className='flex flex-row mt-3'>
                            <Link  to='https://wa.me/254748370829'>
                                <button className='bg-slate-950 text-white px-5 py-1  my-1 rounded-full'>Connect</button>
                            </Link>
        ...
        <div className='flex mt-3 mx-auto justify-between md:w-[60%] '>
            <button className='bg-slate-950 text-white px-5 py-1 text-xs my-1 md:text-base rounded-full'>
                <p>10 Total Projects</p>
            </button>
            <button className='border bg-slate-950 text-white px-5 py-1 ml-4 my-1 text-xs md:text-base rounded-full'>
                10 Clients
            </button>
            <button className='border bg-slate-950 text-white px-5 py-1 ml-4 my-1 text-xs md:text-base rounded-full'>
